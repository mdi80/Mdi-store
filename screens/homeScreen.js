                ...
                <HomeScreenCategoriaclList
                    hadleTitleView={
                        <View style={{ margin: 10 }}>
                            <Text style={{ fontFamily: 'Roboto', color: 'white', fontSize: 25 }}>Amazing     </Text>
                            <Text style={{ fontFamily: 'Roboto', color: 'white', fontSize: 25 }}>   Suggests </Text>
                        </View>
                    }
                    uri="https://www.digikala.com/statics/img/png/specialCarousel/box.png"
                    urlItems="https://www.digikala.com/statics/img/png/specialCarousel/box.png"
                    backColor="#3700b3"
